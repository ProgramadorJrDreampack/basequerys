...
/*
    Actualizacion del query Ordenes Mantenimientos
    1.-Modificar los recurso porque existen 2 y añadir bien los nombre,
    2.-Agregar una columna para ver la fecha de emision de la SC
    3.-Anadir otra columna para el nombre del recurso  
...
SELECT 
    ...
    A3."VatSumSy" AS "Iva",
    (A3."Price" + A3."VatSumSy") AS "Costo total servicio externo",
    A0."TaxDate" AS "Fecha Emision SC", 
