...
CASE         WHEN T0."DocType" = 'I'   THEN 'Fact. de Artículo'         
WHEN T0."DocType" = 'S'   THEN 'Fact de Servicio'         ELSE ' '     END AS "Tipo de Documento",    
...
--COALESCE(T2."TolDays", 0) AS "Días de tolerancia",    -- Sumar días de vencimiento y días de tolerancia    
