...
WHERE 
    ...
    (T2."U_SYP_SUBGRUPO2"='BC' OR T2."U_SYP_SUBGRUPO2"='CV' OR 
    T2."U_SYP_SUBGRUPO2"='RB' OR T2."U_SYP_SUBGRUPO2"='RC' OR 
    T2."U_SYP_SUBGRUPO2"='PE' OR T2."U_SYP_SUBGRUPO2"='PC')


/* ***** se va a actualizar el query de big vision de salida de mercancia por rango de fecha */
SELECT 
