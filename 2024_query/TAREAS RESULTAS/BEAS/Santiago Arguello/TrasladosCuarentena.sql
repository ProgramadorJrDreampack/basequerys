/* ORIGINAL  QUERY MANAGER Inventario -> Traslados Cuarentena */
...
/*
PERFECTO 
Sumatoria dce traslado de cuarentena 
*/
...
SELECT
    ...
    SUM(P0."Cantidad_Lote") AS "Suma_cantidad_lote", 
    SUM(P0."Cantidad_Producida") AS "Suma_cantidad_producida"
FROM ( 
    SELECT 
        T0."DocNum",
        T0."DocDate",
...
WHERE 
  P0."DocDate" BETWEEN '2024-08-01' AND '2024-09-30' 
  --AND P0."Orden" = '19760' -- '30121'
GROUP BY
    --P0."DocDate",
   P0."Orden",  
    P0."ItemCode";
...
WHERE 
  --P0."DocDate" BETWEEN '2024-10-01' AND '2024-11-01' 
  --AND 
P0."Orden" = '30587' -- '30121'
GROUP BY
    --P0."DocDate",
   P0."Orden",  
    P0."ItemCode";
